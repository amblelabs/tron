...
public class KeyBind {
    ...
    public void register() {
        this.self = KeyBindingHelper.registerKeyBinding(new KeyBinding("key." + Tron.MOD_ID + "." + name, this.type,
                this.code, "category." + Tron.MOD_ID + "." + category));
    }
